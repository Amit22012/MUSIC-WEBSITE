...
const songs = [
    {
        id:'1',
        songname:`Wakh Ho Jana
         <br>
        <div class="subtitle">Gurnaam Bhullar</div>`,
        poster:"poster/playlistposter/gurnaamposter/img1.webp"
    },
    {
        id:'2',
        songname:`
        Mera Yaar         <br>
        <div class="subtitle">Gurnaam Bhullar</div>`,
        poster:"poster/playlistposter/gurnaamposter/img2.webp"
    },
    {
        id:'3',
        songname:`Beliya
         <br>
        <div class="subtitle">Gurnaam Bhullar</div>`,
        poster:"poster/playlistposter/gurnaamposter/img3.webp"
    },
    {
        id:'4',
        songname:`Pent Straight
        <br>
        <div class="subtitle">Gurnaam Bhullar</div>`,
        poster:"poster/playlistposter/gurnaamposter/img4.webp"
    },
    {
        id:'5',
        songname:`
        Rog Mera Yaar        <br>
        <div class="subtitle">Gurnaam Bhullar</div>`,
        poster:"poster/playlistposter/gurnaamposter/img5.webp"
    },
    {
        id:'6',
        songname:`Koke Vich Dil
        <br>
        <div class="subtitle"> Gurnaam Bhullar</div>`,
        poster:"poster/playlistposter/gurnaamposter/img6.webp"
    },
    {
        id:'7',
        songname:`Wang Tut Gayi
       
        <br>
        <div class="subtitle">Gurnaam Bhullar</div>`,
        poster:"poster/playlistposter/gurnaamposter/img7.webp"
    },
    {
        id:'8',
        songname:`Pehli Mulaqat
        
        <br>
        <div class="subtitle">Gurnaam Bhullar</div>`,
        poster:"poster/playlistposter/gurnaamposter/img8.webp"
    },
    {
        id:'9',
        songname:`
        ...
        <br>
        <div class="subtitle">Gurnaam Bhullar</div>`,
        poster:"poster/playlistposter/gurnaamposter/img9.webp"
    },
    {
        id:'10',
        songname:`
        Pariyan De Desh (From "Masand" Soundtrack)        <br>
        <div class="subtitle">Gurnaam Bhullar</div>`,
        poster:"poster/playlistposter/gurnaamposter/img10.webp"
    },
    {
        id:'11',
        songname:`Roka
        <br>
        <div class="subtitle">Gurnaam Bhullar</div>`,
        poster:"poster/playlistposter/gurnaamposter/img11.webp"
    },
    {
        id:'12',
        songname:`Fakira
        ...
        <br>
        <div class="subtitle">Gurnaam Bhullar</div>`,
        poster:"poster/playlistposter/gurnaamposter/img12.webp"
    },
    {
        id:'13',
        songname:`Diamond
        ...
        <div class="subtitle">
        Gurnaam Bhullar</div>`,
        poster:"poster/playlistposter/gurnaamposter/img13.webp"
    },
    {
        id:'14',
        songname:`Phone Maar Di
        <br>
        <div class="subtitle">
        Gurnaam Bhullar</div>`,
        poster:"poster/playlistposter/gurnaamposter/img14.webp"
    },
    {
        id:'15',
        songname:`Jhanjran
        ...
        <br>
        <div class="subtitle">Gurnaam Bhullar</div>`,
        poster:"poster/playlistposter/gurnaamposter/img15.webp"
    }
...
Array.from(document.getElementsByClassName('playlistplay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        ...
        music.src=`songs/playlistsongs/gurnaamsongs/s${index}.mp3`;
        music.play();
        playerbtn.classList.add('fa-pause');
        playerbtn.classList.remove('fa-play');
